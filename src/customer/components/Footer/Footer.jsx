        ...
        <div>
            ...
            <Grid className=' bg-black text-white text-center mt-10'
                ...
                <Grid items xs={12} sm={6} md={3} >
                    ...
                    <div>
                        <Button className='pb-5' variant='h6' gutterButtom>patners</Button>
                    </div>
                </Grid>
                ...
                <Grid items xs={12} sm={6} md={3} >
                    ...
                    <div>
                        <Button className='pb-5' variant='h6' gutterButtom>Supports</Button>
                    </div>
                </Grid>
                ...
                <Grid className='pt-20' item xs={12} >
                    ...
                    <Typography variant="body2" component="p" align="center"> Devloped By Jay Prajapati.
                    </Typography>
